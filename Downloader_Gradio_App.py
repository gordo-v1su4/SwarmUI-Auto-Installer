        ...
        "bundles": [
            ...
            },
            {
                ...
                "models_to_download": [
                    ...
                    ("LoRA Models", "Various LoRAs", "Wan 2.1 T2V 14B FusionX LoRA"),
                    ("Video Generation Models", "Wan 2.1 LoRAs", "Wan 2.1 14B LightX2V CFG Step Distill LoRA V2 (T2V + I2V) (Rank 64)"),
                    ("LoRA Models", "Various LoRAs", "Phantom Wan 14B FusionX LoRA"),
                    ("LoRA Models", "Various LoRAs", "Wan 2.1 I2V 14B FusionX LoRA"),
                    ("LoRA Models", "Various LoRAs", "Wan 2.1 14B Self Forcing LoRA T2V/I2V"),
    ...
    "ComfyUI Bundles": {
        ...
        "bundles": [
            ...
            },
            {
                ...
                "models_to_download": [
                    ("LoRA Models", "Various LoRAs", "Wan 2.1 14B LightX2V CFG Step Distill LoRA V2 (T2V + I2V) (Rank 64)"),
...
def get_current_subdirs(is_comfy_ui_structure: bool, is_forge_structure: bool = False):
    ...
    if is_comfy_ui_structure:
        ...
        # Forge WebUI folder structure based on stable-diffusion-webui-forge/models
        # All checkpoint/diffusion models go to Stable-diffusion folder in Forge
        ...
        # VAE models - Forge uses "VAE" not "vae"
        current_s["vae"] = "VAE"  # VAE folder in Forge
        current_s["VAE"] = "VAE"  # Also handle uppercase
        
        # LoRA models - Forge code is inconsistent, uses both "Lora" and "lora"
        # We'll use "Lora" as the standard (capital L) which matches the preload.py default
        ...
        # Text encoders - Forge uses text_encoder folder for CLIP models
        ...
        # Upscaler models - each type has its own folder
        current_s["upscale_models"] = "ESRGAN"  # Default upscalers to ESRGAN
        current_s["ESRGAN"] = "ESRGAN"  # ESRGAN models
        current_s["RealESRGAN"] = "RealESRGAN"  # RealESRGAN models
        current_s["BSRGAN"] = "BSRGAN"  # BSRGAN models
        current_s["DAT"] = "DAT"  # DAT models
        current_s["SwinIR"] = "SwinIR"  # SwinIR models
        current_s["ScuNET"] = "ScuNET"  # ScuNET models
        ...
        current_s["torch_deepdanbooru"] = "torch_deepdanbooru"  # Deepdanbooru models
        
        # Additional model types
        current_s["hypernetworks"] = "hypernetworks"  # Hypernetworks (lowercase)
        current_s["LyCORIS"] = "LyCORIS"  # LyCORIS networks
        current_s["VAE-taesd"] = "VAE-taesd"  # TAESD VAE models
        current_s["VAE-approx"] = "VAE-approx"  # VAE approximation models
        
        # Depth estimation models
        current_s["leres"] = "leres"  # Leres depth models (lowercase)
        current_s["midas"] = "midas"  # Midas depth models (lowercase)
        
        # IPAdapter models
        current_s["ipadapter"] = "ipadapter"  # IPAdapter models (lowercase)
        
        # Other model directories Forge might use
        current_s["svd"] = "svd"  # SVD models (lowercase)
        current_s["z123"] = "z123"  # Zero123 models (lowercase)
        current_s["karlo"] = "karlo"  # Karlo models (lowercase)
        
        # Note: embeddings directory is at root level (not in models), handled separately by Forge
    return current_s
